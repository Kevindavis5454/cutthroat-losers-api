...
//
app.get('/api/contestInfo/sabotages', routes.contestSabotages)/// NOT USED
...
//
app.get('/api/contestInfo/getPointsGainedBingo', routes.getPointsGainedBingo) /// NOT USED
app.get('/api/contestInfo/getPointsSpentBlock', routes.getPointsSpentBlock)/// NOT USED
app.get('/api/contestInfo/getPointsSpentSabotage', routes.getPointsSpentSabotage)///NOT USED


app.get('/api/points', routes.pointsValue)
//
app.get('/api/points/bingo', routes.bingoPointsValue)/// NOT USED
